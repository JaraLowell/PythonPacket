...
function debug(message) {
    writeCon(colorRed, LogLevelEnum.DEBUG, message);
...
function chat(message) {
    writeCon(colorGreen, LogLevelEnum.INFO, message);
    writeLog(LogLevelEnum.INFO, message);
};

function warn(message) {
    writeCon('\u001B[1m' + colorYellow, LogLevelEnum.WARN, message);
...
function writeCon(color, level, message) {
    ...
    process.stdout.write(prefix + color  + message + "\u001B[0m" + EOL);
};
...
var logFolder = "/var/run/log";
var logBackupFolder = "/var/run/log/LogBackup";
var logFileName = "AX25Serv";
