...
L.Maidenhead = L.LayerGroup.extend({
    ...
    _getLabel: function(lon,lat) {
        ...
        var title = '<span style="cursor: default;"><font style="color:'+this.options.Lcolor+'; font-size:'+size+'; font-weight: 900; ">' + this._getLocator(lon,lat) + '</font></span>';
